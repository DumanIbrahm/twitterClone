...
import 'package:twitter_clone/my_pages/Settings/SettingsDetails/filtre_page.dart';
import 'package:twitter_clone/my_pages/Settings/preferences.dart';
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle:
                const Text("Görmek istediğin ve istemediğin bildirimleri seç.",
                    style: TextStyle(
                      color: Colors.white,
                    )),
            trailing: IconButton(
          ...
          ListTile(
            ...
            title:
                const Text("Tercihler", style: TextStyle(color: Colors.white)),
            subtitle: const Text("Bildirim türüne göre tercihlerini seç.",
                style: TextStyle(color: Colors.white)),
            trailing: IconButton(
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
